# Vector Labs Studio Knowledge Sharing
...
- Markdown styles, text formats, or template schemas (reserved for `DOCUMENTATION_STANDARDS.md`)
- Training plans, bootcamps, onboarding pathways, or tutorial videos
- Specific knowledge bases, wikis, source repositories, or documentation tools
- Handoff checklists, status report schedules, or meeting guidelines
- Job descriptions, employee manuals, or career ladders
