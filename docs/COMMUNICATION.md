# Vector Labs Studio Communication
...
- Specific communication tools (e.g., Slack, email, chat clients) or platforms
- Meeting schedules, formats, agendas, or time-blocking practices
- Writing style guides, markdown formatting, or document templates (reserved for `DOCUMENTATION_STANDARDS.md`)
- How knowledge is organized, taught, or retained (reserved for `KNOWLEDGE_SHARING.md`)
- Workflow steps, task statuses, or code-review templates
