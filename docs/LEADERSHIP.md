...
## Purpose
This document defines the leadership philosophy of Vector Labs Studio. It answers a single question: **How is direction created within the Studio?** It outlines the principles of how leadership guides activity, alignment, and capability without relying on centralized control. Rather than defining reporting lines, people management procedures, or hierarchy templates, these principles govern how direction is cultivated and scaled across all contributors.
...
- Organizational reporting lines, department hierarchies, or job structures (reserved for `ORGANIZATION_PRINCIPLES.md`)
- People management operations, recruiting, compensation, or promotion policies
- Task assignment mechanics, delegation frameworks, or daily check-ins
- Detailed performance management, reviews, or disciplinary procedures
- Concrete strategic roadmaps or short-term product plans
